...
@Configuration
@EnableJpaRepositories("com.company.server.repository")
@EnableTransactionManagement
@PropertySource("classpath:db.properties")
@ComponentScan("com.company.server")
public class DatabaseConfig {
    ...
    private Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalArgumentException("Missing hibernate.properties Bitch!!", ex);
        }
    }
